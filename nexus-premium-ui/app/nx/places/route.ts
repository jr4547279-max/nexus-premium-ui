...
const ACTIVITY_SEARCH: Record<string, { query: string; type?: string }> = {
  'jogging': { query: 'running tracks and running routes', type: 'sports_activity_location' },
  'walking': { query: 'walking trails and parks', type: 'park' },
  'hiking': { query: 'hiking trails and hiking areas', type: 'hiking_area' },
  'cycling': { query: 'cycling routes and cycle trails', type: 'cycling_park' },
