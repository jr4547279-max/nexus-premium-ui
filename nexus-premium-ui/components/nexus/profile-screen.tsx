    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <main className="px-4 py-4 max-w-md mx-auto">
        <div className="flex flex-col items-center mb-6">
          ...
          <Button onClick={() => onNavigate('onboarding')} variant="outline" size="sm" className="mt-3 h-8 rounded-lg text-xs gap-1.5 border-primary/30 hover:bg-primary/10">
