...
const COPY: Record<Language, Record<string, string>> = {
  ...
  es: { profile: 'Perfil', location: 'Ubicación', noLocation: 'Sin ubicación', locationHelp: 'Necesario para los puntos medios de Golden Window', cityOnly: 'Solo la ciudad se muestra a los miembros', update: 'Actualizar', setLocation: 'Definir ubicación', calendars: 'Calendarios conectados', connected: 'Conectado', addCalendar: 'Añadir calendario', preferences: 'Preferencias', notifications: 'Notificaciones', darkMode: 'Modo oscuro', language: 'Idioma', editPreferences: 'Editar preferencias', privacy: 'Configuración de privacidad, facturación y asistencia próximamente', delete: 'Eliminar cuenta', signOut: 'Cerrar sesión', account: 'Cuenta', languageSaved: 'Preferencia de idioma guardada', themeSaved: 'Preferencia de tema guardada', notificationSaved: 'Preferencia de notificaciones guardada', deletion: 'Eliminación de cuenta', deletionHelp: 'La eliminación de cuenta aún no está disponible.' },
