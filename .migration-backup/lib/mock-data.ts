...
export const mockActivity = [
  ...
  },
  {
    ...
    description: 'Until 3:00 PM today',
    time: '9:42 AM',
    icon: 'clock',
  },
  {
  ...
  },
  {
    ...
    description: 'Google Calendar updated',
    time: '9:50 AM',
    icon: 'refresh',
  },
  {
    id: '6',
    type: 'alignment',
    title: 'New alignment detected',
    description: 'Family Dinner group',
    time: '10:15 AM',
    icon: 'target',
  },
]
